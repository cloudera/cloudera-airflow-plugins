...
from cloudera.cdp.security.cde_security import (
    CdeApiTokenAuth,
    CdeTokenAuthResponse,
    GetAuthTokenError,
)
from cloudera.cdp.security.cdp_requests.cdpcurl import make_request
from cloudera.cdp.security.cdp_security import (
...
class CDPRequestsTestCase(TestCase):
    ...
    @patch(
        'cloudera.cdp.security.cdp_requests.cdpcurl.make_signature_header',
        return_value="signature",
    )
    @patch(
        'cloudera.cdp.security.requests.request',
        side_effect=[
